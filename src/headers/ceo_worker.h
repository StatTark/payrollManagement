...
#ifndef PAYROLL_CEO_WORKER_H
#define PAYROLL_CEO_WORKER_H

#include "title.h"

class Ceo : public Title
{
private:
    int tId;
    std::string jobTitle;
...
public:
    ...
    Ceo(int id, std::string job_Title, double sumHours, double per_HourCost)
    {
        tId = id;
        jobTitle = job_Title;
        sumHoursM = sumHours;
