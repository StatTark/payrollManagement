...
#ifndef PAYROLL_MANAGER_WORKER_H
#define PAYROLL_MANAGER_WORKER_H
...
public:
    ...
    Manager(int id, std::string job_Title, double sumHours, double per_HourCost)
    {
        tId = id;
        jobTitle = job_Title;
        sumHoursM = sumHours;
...
#endif //PAYROLL_MANAGER_WORKER_H
